...
<html lang="en">
  ...
  >
    ...
    >
      <h1
        class="md:text-8xl md:w-5/6 mx-auto sm:text-4xl text-2xl font-bold text-left md:px-6"
      >
        Welcome to Marketing Department
      </h1>
      <p
        class="font-bold md:w-5/6 mx-auto md:text-4xl text-lg underline text-left mt-4 md:px-6"
      >
    ...
    <!-- CTA section -->
    <div
      class="py-16 bg-green-800 text-white text-center bg-center bg-auto"
    >
      ...
      <div
        class="py-4 flex gap-8 md:flex-row flex-col items-center justify-center"
      >
        <p class="border border-white hover:bg-white hover:text-green-800 transition-all px-3 md:px-10 py-3 text-xl mr-2">
          <a href="#">Plan a Visit <i class="fa-solid fa-angle-right"></i></a>
        </p>
        <p class="border hover:bg-white hover:text-green-800 transition-all border-white px-3 md:px-10 py-3 text-xl mr-2">
    ...
    <section class="md:w-3/4 mx-auto mt-10">
      <div class="flex flex-col md:flex-row md:gap-8">
        ...
        <div class="mx-auto hidden md:block my-10 w-1/2">
          <iframe
            width="560"
            height="315"
            src="https://www.youtube.com/embed/1Y9X3dZMYZk?si=QjFa61fhcwMi1ThF"
            frameborder="0"
      ...
      <div class="mx-auto flex flex-col md:flex-row md:gap-8">
        ...
        <div class="mx-auto border border-red-600 p-4 space-y-4 w-1/2">
          ...
          <div
            class="flex md:flex-row flex-col gap-4 items-center justify-center"
          >
            <button
              class="px-3 py-6 bg-green-800 text-white font-bold hover:bg-white hover:text-green-800"
            >
      ...
      <div class="mx-auto flex flex-col space-y-4 md:flex-row md:gap-8 mt-10">
        <div
          class="mx-auto w-1/2 p-8 h-80 text-white flex items-center justify-center flex-col bg-yellow-400"
        >
        ...
        <div
          class="mx-auto w-1/2 bg-green-400 flex flex-col items center justify-center"
        >
    ...
    <section
      class="md:w-3/4 mx-auto mt-10 p-10 bg-green-800 flex items-center flex-col"
    >
      ...
      <button
        class="bg-green-400 text-green-800 hover:bg-white px-8 py-3 text-xl mt-6 font-semibold transition-all"
      >
    ...
    <section class="md:w-3/4 mx-auto mt-12 bg-white">
      ...
      <div
        class="border border-green-800 w-10/12 mx-auto bg-white text-green-800 mt-20"
      >
        <h3
          class="-mt-6 mb-10 w-1/3 mx-auto text-white bg-green-800 px-8 py-4 md:text-2xl font-bold text-center"
        >
          OUR CHAMPIONS
        </h3>
    ...
    <div class="w-3/4 mx-auto mt-16 flex flex-wrap justify-center gap-8 p-6">
      ...
      <div class="flex-1 min-w-[300px] bg-white p-6 w-5/6 shadow-md">
        ...
        <form
          action="mailto:marketing@dkut.ac.ke"
          method="post"
          class="space-y-4"
        >
          <!-- Subject of Feedback -->
          <div>
            <label for="subject" class="block font-medium text-gray-700"
              >What aspect of the marketing team would you like to comment
              on?</label
            >
            <select
              id="subject"
            ...
            >
              ...
              <option value="customer_engagement" class="hover:bg-green-200 p-3">Customer Engagement</option>
            </select>
          </div>

          <!-- Feedback Type -->
          <div>
            <label for="feedback_type" class="block font-medium text-gray-700"
              >What type of feedback would you like to share?</label
            >
            <select
              id="feedback_type"
              name="feedback_type"
          ...
          <div>
            ...
            <textarea
              ...
              class="w-full p-3 border focus:outline-none focus:ring focus:ring-green-300"
            ></textarea>
          </div>
    ...
    <footer class="bg-green-900 text-white text-center p-6">
      ...
      <div class="mt-4">
        ...
        <div class="space-x-4">
          <a href="#" class="text-white hover:text-gray-300 text-xl"
